...
GeoJSONContext.prototype = geoJSONContext.prototype = {
  ...
  quadraticCurveTo: function (x1, y1, x, y) {
    var path = index$2([this._x1, this._y1], [+x1, +y1], [(this._x1 = +x), (this._y1 = +y)], this._scale);
  ...
  bezierCurveTo: function (x1, y1, x2, y2, x, y) {
    var path = index$1([this._x1, this._y1], [+x1, +y1], [+x2, +y2], [(this._x1 = +x), (this._y1 = +y)], this._scale);
    this._[this._i].pop();
    Array.prototype.push.apply(this._[this._i], path);
  },
...
var index = {geoJSONContext: geoJSONContext};
